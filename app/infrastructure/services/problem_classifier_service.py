...
class ProblemClassifierService:
    ...
    def _build_keyword_dictionary(self) -> Dict[str, Dict[str, float]]:
        ...
        return {
            "ENGINE": {
                # Peso 5: Keywords ultra-específicos
                "motor": 5.0,
                "pistón": 5.0,
                "biela": 5.0,
                "válvula": 5.0,
                "cilindro": 5.0,
                "bujía": 5.0,
                # Peso 4: Keywords muy específicos
                "aceite": 4.0,
                "filtro de aceite": 4.0,
                "correa de distribución": 4.0,
                "cadena de distribución": 4.0,
                # Peso 3: Keywords moderados
                "humea": 3.0,
                "humo": 3.0,
                "temperatura": 3.0,
                "sobrecalienta": 3.0,
                # Peso 2: Keywords débiles
                "ruido del motor": 2.0,
                "vibración del motor": 2.0,
            },
            ...
            "TRANSMISSION": {
                ...
                "primera velocidad": 4.0,
                "segunda velocidad": 4.0,
                "reversa": 4.0,
                "neutro": 4.0,
            ...
            "BRAKES": {
                ...
                "pedal de freno": 4.0,
                "líquido de frenos": 4.0,
                "abs": 4.0,

                "chirrido al frenar": 3.0,
                "vibra al frenar": 3.0,
                "se hunde el pedal": 3.0,
            },
            ...
            "AIR_CONDITIONING": {
                ...
                "aire acondicionado": 5.0,
                "clima": 5.0,
                "a/c": 5.0,
                "compresor": 5.0,

                "no enfría": 4.0,
                "gas refrigerante": 4.0,
                "condensador": 4.0,

                "ventilador": 3.0,
                "temperatura interior": 3.0,
            },
